...
abstract: >
  ...
  aggregations without transferring intermediate results to R, achieving speedups of up to 16.7-fold over the pure-R fallback for large municipalities, at a fraction of its peak memory.
draft: false
author:
...
result to R. This design achieves speedups of up to 16.7$\times$ over a
pure-R fallback
...
5.  **DuckDB dual-backend**: a performance architecture that achieves up
    to 16.7× speedup for large municipalities, at a fraction of the
    pure-R backend's peak memory, by streaming the cached gzipped CSV,
    assigning H3 cells, and performing spatial joins entirely within an
