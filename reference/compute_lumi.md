...
#> ℹ Step 1/3: Ensuring ZIP and inspecting archive...
#> ✔ Step 1/3 (CNEFE ZIP ready) [12ms]
#> 
#> ℹ Step 2/3: Counting addresses per H3 cell...
#> ✔ Step 2/3 (Addresses counted) [234ms]
#> 
#> ℹ Step 3/3: Building grid and computing LUMI...
#> ✔ Step 3/3 (Land use mix indices computed) [166ms]
#> 
...
#> ℹ Step 1/3: Ensuring data and preparing polygon...
#> ✔ Step 1/3 (Data and polygon ready) [24ms]
#> 
...
#> ✔ Step 3/3 (Land use mix indices computed) [51ms]
#> 
# }
```
