...
> DuckDB pays a fixed cost to initialise the connection, load the H3
> extension and materialise data into its in-memory storage before any
> computation begins. When the dataset is small, that setup cost
> outweighs the gains from its query engine.
