...
#> 
#> ℹ Reading file1dc9377345e3.csv.gz with arrow
#> ✔ Reading file1dc9377345e3.csv.gz with arrow [24ms]
#> 
...
#> 
#> ℹ Reading file1dc9312ada07.csv.gz with arrow
#> ✔ Reading file1dc9312ada07.csv.gz with arrow [23ms]
#> 
#> ✔ Read 9354 records from CNEFE
#> ℹ Writing cnefe_2022_2929057.parquet
#> ✔ Writing cnefe_2022_2929057.parquet [21ms]
#> 
#> ✔ Wrote 9354 records to /tmp/Rtmpjau5NC/cnefe_2022_2929057.parquet (0.3 MB).
...
#> Downloading ZIP (timeout = 300s): https://ftp.ibge.gov.br/Cadastro_Nacional_de_Enderecos_para_Fins_Estatisticos/Censo_Demografico_2022/Arquivos_CNEFE/CSV/Municipio/29_BA/2929057_SAO_FELIX_DO_CORIBE.zip
#> ℹ Converting the archive to .csv.gz (done once)
#> ✔ Converting the archive to .csv.gz (done once) [80ms]
#> 
#> ℹ Reading file1dc924565335.csv.gz with arrow
#> ✔ Reading file1dc924565335.csv.gz with arrow [23ms]
#> 
#> ✔ Read 9354 records from CNEFE
