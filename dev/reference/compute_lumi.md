...
#> ✔ Converting the archive to .csv.gz (done once) [43ms]
#> 
#> ℹ Step 1/3: Ensuring the CNEFE data file...
#> ✔ Step 1/3 (CNEFE data ready) [517ms]
#> 
...
#> ℹ Converting the archive to .csv.gz (done once)
#> ✔ Converting the archive to .csv.gz (done once) [565ms]
#> 
#> ℹ Step 1/3: Ensuring data and preparing polygon...
...
#> ✔ Step 3/3 (Land use mix indices computed) [61ms]
#> 
# }
```
