...
## Roadmap
The current version focuses on efficiently downloading, caching, and reading municipality-level CNEFE CSV files into Arrow tables or `sf` objects for downstream analysis. Planned extensions include:
